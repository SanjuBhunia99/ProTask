...
// const TOKEN_EXPRESS = '24h';
// const createToken = (userId) => jwt.sign({ id: userId }, JWT_SECRET, { expressIn: TOKEN_EXPRESS });
...
//         return res.status(400).json({ sucess: false, message: "Password must be atleast 8 character" });
//     }
...
//         res.status(201).json({ success: true, token, user: { id: user_.id, name: user.name, email: user.email } });
//     }
//     catch (err) {
//         console.log(err);
