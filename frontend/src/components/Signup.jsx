...
// const API_BASE = "https://protask-backend-7znq.onrender.com";
...
//         if (data?.success) {
//           const userId = data.user?.id || data.user?._id; // ✅ FIXED
...
const Signup = ({ onSubmit, onSwitchMode }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await API.post("/api/user/register", formData); // ✅ FIXED
